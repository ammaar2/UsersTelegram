...
class ChackUserName:
    ...
    def generate_username(self):
        numb=0
        while True:
            user=self.user_gen(random.choice(["#*#_#",
            "###**##",
            "#*#_*",
            "##_**",
            "###**",
    ...
    def Chack_UserName_Flood(self,user):
        ...
        for chat in all_chat:
            if chat.name == f"CLAIM-SAGAD[{user}]" and not chat.entity.username:
    ...
    def save_username_to_channel(self,user):
        ...
        try:
            ...
            video_message = self.Client.get_messages('rmrmrmr', ids=video_message_id)
    ...
    def Get_Session():
        while True:
            phone = '+18189258851'#Your phone number 
            if phone == '+18189258851':phone = input("> Enter Phone Number Telegram :")
